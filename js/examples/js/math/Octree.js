...
/*
						...
						this.jsonStr += '{"points":[{"x":' + v1.x.toString() + ',"y":' + v1.y.toString() + ',"z":' + v1.z.toString()
									+ '},{"x":' + v2.x.toString() + ',"y":' + v2.y.toString() + ',"z":' + v2.z.toString()
									+ '},{"x":' + v3.x.toString() + ',"y":' + v3.y.toString() + ',"z":' + v3.z.toString()
									+ '}]}'
*/
