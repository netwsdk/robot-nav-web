...
OccupancyGrid = function(options) {
  ...
  this.mesh.position.x = (width * info.resolution) / 2 + origin.position.x;
  this.mesh.position.y = (height * info.resolution) / 2 + origin.position.y;
  this.mesh.position.z = origin.position.z;
  this.mesh.scale.x = info.resolution;
  this.mesh.scale.y = info.resolution;
...
OccupancyGrid.prototype.dispose = function() {
 ...
 */
OccupancyGrid.prototype.getValue = function(index, row, col, data) {
  return data[index];
};
 ...
 */
OccupancyGrid.prototype.getColor = function(index, row, col, value) {
  return [
